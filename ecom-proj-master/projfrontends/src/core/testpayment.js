...
const Razorpay = ({ products, setReload = f => f, reload = undefined }) => {
    ...
    return (
        ...
        <div className="cart-details-container-form">
            ...
            <input type="text" onChange={handleChange} value={phone} className="cart-details-container-form-phone-input" placeholder="Phone Number" />
            <h3 className="cart-details-container-form-phone">Address</h3>

            <div className="cart-details-container-form-address" action="">
